...
public class Idman {
    ...
    public void burpeeYap( int sayi) {
        if(burpee_sayisi == 0) {
            System.out.println("Yapacak burpee hareketi kalmamıştır.");
        }
    ...
    public void pushupYap (int sayi) {
        if(pushup_sayisi == 0){
            System.out.println("Yapacak pushup hareketi kalmamıştır.");
        }
        if((pushup_sayisi - sayi) < 0 ) {
            System.out.println("Hedeflediğin pushp sayısını geçtin. Tebrikler.");
            pushup_sayisi = 0;
    ...
    public void situpYap(int sayi) {
        if(situp_sayisi == 0){
            System.out.println("Yapacak situp hareketi kalmamıştır.");
        }
    ...
    public void squatYap(int sayi) {
        if(squat_sayisi == 0){
            System.out.println("Yapacak squat hareketi kalmamıştır.");
        }
